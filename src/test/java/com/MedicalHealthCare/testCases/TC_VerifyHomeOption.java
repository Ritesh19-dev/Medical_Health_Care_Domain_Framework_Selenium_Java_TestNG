...
public class TC_VerifyHomeOption extends BaseClass
{
	@Test(groups = {"sanityTest","regressionTest"})
	public void verifyHomeOption() throws IOException
	{
		logger.info("\n********************TEST CASE VERIFY HOME OPTION STARTED*********************");
		...
		homeOption.click();
		logger.info("HOME OPTION IS CLICKED");
